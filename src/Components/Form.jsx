...
const Form = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center rounded-[20px] border border-liner p-3 w-full max-w-[604px] mx-auto">
      ...
      <ProgressBar completed={33.3} customLabel=' ' maxCompleted={100} width='550px' height='5px'bgColor='#24A0B5' />
      ...
      <div className="border border-liner p-4 sm:p-6 mx-2 sm:mx-4 mt-3 rounded-[20px] bg-[#08252B] w-full">
        <div className="bg-[#07373F] flex flex-col justify-center items-center py-4 px-5 sm:py-5 sm:px-7 rounded-[20px]">
          ...
          <p className="text-sm sm:text-base">[Event Location] || March 15, 2025 | 7:00PM</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between w-full gap-3">
          ...
          <button onClick={() => navigate('/generate')} className="border border-[#24A0B5] font-jeju font-light w-full sm:w-[48%] py-2 rounded-md cursor-pointer hover:bg-[#24A0B5] active:bg-[#24A0B5]">
            Next
          </button>
        </div>
      </div>
